...
- [ ] Phase A2: Add commit filtering — skip already-indexed commits in IndexReview
- [ ] Phase A3: Add --incremental CLI flag to review index command
- [ ] Phase A4: Integration test — index 5, then index 10, verify only 5 new commits processed
- [ ] Phase A5: Benchmark incremental vs full re-index
- [ ] Phase B1: Create schema_v2.go with normalized tables + compatibility views
- [ ] Phase B2: Rewrite LoadSnapshot for normalized inserts (INSERT OR IGNORE + mapping tables)
- [ ] Phase B3: Update review store ResetSchema for v2
- [ ] Phase B4: Run existing tests against v2 schema via compatibility views
- [ ] Phase B5: Verify React browser still works with v2 views
- [ ] Phase B6: Benchmark v2 DB size vs v1
